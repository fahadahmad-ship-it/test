...
def main(src, outdir):
    ...
    # No disavow file is written here. This pass sees only the sampled
    # links, so its verdict covers 2,376 of the 2,928 referring domains --
    # it once wrote a 634-domain disavow.txt alongside the authoritative
    # 1,183-domain file, and submitting the wrong one would silently drop
    # half the list. refdomain_audit.py owns the disavow output.
